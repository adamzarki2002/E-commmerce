...
<html lang="en">
	...
	<body>
      ...
      <div class="wrapper">
               ...
               <form class="p-3 mt-3">
                   <div class="form-field d-flex align-items-center">  <input type="numCli" name="numCli" id="numCli" placeholder="numero du client" required="required"> </div>
                   <div class="form-field d-flex align-items-center">  <input type="password" name="pass" id="pass" placeholder="Password" required="required"> </div>   <button class="btn mt-3">Login</button>
                   <div class="text-center fs-6">
         <a href="inscription.jsp" style="width: 200px;">Sign up</a>
        </div>
