        ...
        <div class="row">
          <!-- left column -->
            ...
            <div class="card card-primary" style="margin-left:255px">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<%=request.getContextPath()%>/ajouterfamille"; method="post">
                <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">Famill du Prodruit<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nomFam" placeholder="Enter nom du Famille" required="required">
                  </div>     
                <!-- /.card-body -->
