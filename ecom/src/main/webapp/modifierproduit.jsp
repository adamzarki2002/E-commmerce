        ...
        <div class="row">
          <!-- left column -->
            ...
            <div class="card card-primary" style="margin-left:255px">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<%=request.getContextPath()%>/modifierproduit"; method="post">
                <div class="card-body">
             <div class="form-group">
                    <label for="exampleInputEmail1">Num du Produit<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="numPro" value="${em.numPro}" required="required">
                  </div> 
                <div class="form-group">
                    <label for="exampleInputEmail1">Nom du Produit<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nomPro" value="${em.nomPro}" required="required">
                  </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Prix du Produit<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="puProd" value="${em.puProd}" required="required">
                  </div>  
                  <%--  <div class="form-group">
                    <label for="exampleInputEmail1">Famille du Produit<span class="required">*</span></label>
                     <select value="${em.famPro}" name="famPro" id="famPro"  class="form-control select1" style="width: 100%;" required>
                  
                    <option value="${em.famPro}" selected disabled>${em.famPro}</option>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Famille du Produit<span class="required">*</span></label>
                         <c:forEach var="em" items="${familleP}">
                                             <option >${em.nomFam}</option>
                                      </c:forEach> 
                            <select name="famPro" class="form-control select1" style="width: 100%;" required>
                    ...
                    <label for="exampleInputEmail1">Photo du Produit<span class="required">*</span></label>      
                           ...
                           <form action="/action_page.php">
  							<input type="file" id="photoP" name="photoP" value="image/${em.photoP}">
										</form>   
										</div>            
                <!-- /.card-body -->
                ...
                <div class="item form-group">
                        <div class="col-md-8 col-sm-8 offset-md-4">
                          <a href="listeP"><button class="btn btn-primary" type="button">Annuler</button></a>
